...
train_instances = []
with open('test_trainset.txt', 'r') as f:
    for line in f:
...
# test_instances = test_instances[:2]
...
if __name__ == '__main__':
    ...
    for metric in metrics:
        ...
        default_config = \
            dict(igaci.engine_param_spaces[engine[0]].get_default_configuration())

        # check configurations performance
        perf = IAC.evaluate(metric, engine[0], 'OneshotPlanner',
                            default_config, igaci, planner_timelimit=30)
