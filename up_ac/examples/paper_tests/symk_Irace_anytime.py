...
train_instances = []
with open('instance_lists/fast-downward_train.txt', 'r') as f:
    for line in f:
        train_instances.append(eval(line.strip()))

# Test Instance Set
test_instances = []
with open('instance_lists/fast-downward_test.txt', 'r') as f:
    for line in f:
...
if __name__ == '__main__':
    ...
    for metric in metrics:
        ...
        IAC.set_scenario(engine[0],
                         ...
                         configuration_time=40000, n_trials=300,
                         crash_cost=0, min_budget=3,
                         planner_timelimit=300, n_workers=4,
                         instance_features=None, metric=metric)
